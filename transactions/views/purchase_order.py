...
from transactions.forms.purchase_order import PurchaseOrderModelCreateForm, PurchaseOrderModelUpdateForm, \
    get_po_item_formset
from transactions.models import PurchaseOrderModel, ItemThroughModel
from transactions.utils import new_po_protocol
...
class PurchaseOrderModelListView(LoginRequiredMixIn, ArchiveIndexView):
    template_name = 'transactions/po_list.html'
...
class PurchaseOrderModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/po_create.html'
    ...
    def get_success_url(self):
        ...
        return reverse('transactions:po-list',
                       kwargs={
...
class PurchaseOrderModelUpdateView(LoginRequiredMixIn, UpdateView):
    ...
    template_name = 'transactions/po_update.html'
    extra_context = {
        'header_subtitle_icon': 'uil:bill'
    }
    update_items = False
...
class PurchaseOrderModelDetailView(LoginRequiredMixIn, DetailView):
    ...
    slug_field = 'uuid'
    context_object_name = 'po_model'
    template_name = 'transactions/po_detail.html'
    extra_context = {
        'header_subtitle_icon': 'uil:bill',
        'hide_menu': True
    }
...
class PurchaseOrderModelDeleteView(LoginRequiredMixIn, DeleteView):
    ...
    slug_field = 'uuid'
    context_object_name = 'po_model'
    template_name = 'transactions/po_delete.html'
    extra_context = {
        'hide_menu': True,
        'header_subtitle_icon': 'uil:bill'
    }
    ...
    def delete(self, request, *args, **kwargs):
        ...
        if po_items_qs.exists():
            messages.add_message(request,
                                 ...
                                 level=messages.ERROR,
                                 extra_tags='is-danger')
            url = reverse('transactions:po-update',
                          kwargs={
                              'entity_slug': self.kwargs['entity_slug'],
                              'po_pk': self.kwargs['po_pk']
                          })
