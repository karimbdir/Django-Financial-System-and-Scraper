...
from transactions.forms.item import (
...
from transactions.models import ItemModel, UnitOfMeasureModel, EntityModel
...
class UnitOfMeasureModelListView(LoginRequiredMixIn, ListView):
    template_name = 'transactions/uom_list.html'
...
class UnitOfMeasureModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/uom_create.html'
    ...
    def get_success_url(self):
        return reverse('transactions:uom-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class UnitOfMeasureModelUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'transactions/uom_update.html'
...
class ProductsAndServicesListView(LoginRequiredMixIn, ListView):
    template_name = 'transactions/product_list.html'
...
class ProductOrServiceCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/product_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('transactions:product-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ProductOrServiceUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'transactions/product_update.html'
...
class ExpenseItemCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/expense_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('transactions:expense-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ExpenseItemUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'transactions/expense_update.html'
...
class InventoryItemModelListView(LoginRequiredMixIn, ListView):
    template_name = 'transactions/inventory_item_list.html'
...
class InventoryItemCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/inventory_item_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('transactions:inventory-item-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class InventoryItemUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'transactions/inventory_item_update.html'
