...
from transactions.forms.customer import CustomerModelForm
...
class CustomerModelListView(LoginRequiredMixIn,
                            ListView):
    template_name = 'transactions/customer_list.html'
...
class CustomerModelCreateView(LoginRequiredMixIn,
                              CreateView):
    template_name = 'transactions/customer_create.html'
...
class CustomerModelUpdateView(LoginRequiredMixIn,
                              UpdateView):
    template_name = 'transactions/customer_update.html'
