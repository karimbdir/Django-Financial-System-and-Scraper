...
from transactions.forms.account import AccountModelUpdateForm, AccountModelCreateForm, AccountModelCreateChildForm
...
class AccountModelUpdateView(LoginRequiredMixIn, UpdateView):
    ...
    template_name = 'transactions/account_update.html'
...
class AccountModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/account_create.html'
...
class AccountModelCreateChildView(AccountModelCreateView):
    template_name = 'transactions/account_create_child.html'
...
class AccountModelDetailView(LoginRequiredMixIn, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        loc_date = localdate()
        return reverse('transactions:account-detail-month',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
