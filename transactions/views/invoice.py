...
from transactions.forms.invoice import InvoiceModelUpdateForm, InvoiceModelCreateForm, InvoiceItemFormset
from transactions.models import EntityModel, LedgerModel
from transactions.models.invoice import InvoiceModel
from transactions.utils import new_invoice_protocol, mark_accruable_paid
from transactions.views.mixins import LoginRequiredMixIn


class InvoiceModelListView(LoginRequiredMixIn, ArchiveIndexView):
    template_name = 'transactions/invoice_list.html'
...
class InvoiceModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/invoice_create.html'
    ...
    def get_success_url(self):
        entity_slug = self.kwargs['entity_slug']
        return reverse('transactions:invoice-list',
                       kwargs={
                           'entity_slug': entity_slug
                       })
...
class InvoiceModelUpdateView(LoginRequiredMixIn, UpdateView):
    ...
    template_name = 'transactions/invoice_update.html'
    ...
    def get_success_url(self):
        ...
        return reverse('transactions:invoice-detail',
                       kwargs={
                           'entity_slug': entity_slug,
...
class InvoiceModelItemsUpdateView(LoginRequiredMixIn, View):
    ...
    def post(self, request, entity_slug, invoice_pk, **kwargs):
        ...
        return HttpResponseRedirect(reverse('transactions:invoice-update',
                                            kwargs={
                                                'entity_slug': entity_slug,
                                                'invoice_pk': invoice_pk
                                            }))
...
class InvoiceModelMarkPaidView(LoginRequiredMixIn,
    ...
    def post(self, request, *args, **kwargs):
        ...
        messages.add_message(request,
                             ...
                             extra_tags='is-success')
        redirect_url = reverse('transactions:invoice-detail',
                               kwargs={
                                   'entity_slug': self.kwargs['entity_slug'],
...
class InvoiceModelActionView(LoginRequiredMixIn, SingleObjectMixin, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('transactions:invoice-update',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
