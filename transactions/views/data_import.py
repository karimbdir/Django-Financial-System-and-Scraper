...
from transactions.forms.data_import import OFXFileImportForm
from transactions.forms.data_import import StagedTransactionModelFormSet
from transactions.io.ofx import OFXFileManager
from transactions.models.accounts import AccountModel
from transactions.models.bank_account import BankAccountModel
from transactions.models.data_import import ImportJobModel, StagedTransactionModel
...
class DataImportJobsListView(LoginRequiredMixIn, ListView):
    ...
    template_name = 'transactions/data_import_job_list.html'
...
class DataImportOFXFileView(LoginRequiredMixIn, FormView):
    template_name = 'transactions/data_import_ofx.html'
...
class DataImportJobDetailView(LoginRequiredMixIn, DetailView):
    template_name = 'transactions/data_import_job_txs.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        if not cash_account_model:
            bank_acct_url = reverse('transactions:bank-account-update',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug'],
