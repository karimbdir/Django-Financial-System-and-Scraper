...
from transactions.models import EntityModel, InvoiceModel, BillModel
from transactions.models.entity import EntityReportManager
from transactions.settings import transactions_LOGIN_URL
from transactions.utils import set_default_entity
...
class LoginRequiredMixIn(DJLoginRequiredMixIn):
    ...
    def get_login_url(self):
        return reverse('transactions:login')
...
class BaseDateNavigationUrlMixIn:
    ...
    def get_base_date_nav_url(self, context, **kwargs):
        ...
        context['date_navigation_url'] = reverse(f'transactions:{view_name_base}',
                                                 kwargs={
