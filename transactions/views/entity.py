...
from transactions.forms.app_filters import AsOfDateFilterForm, EntityFilterForm
from transactions.forms.entity import EntityModelUpdateForm, EntityModelCreateForm
from transactions.models import EntityModel, EntityUnitModel
...
from transactions.views.mixins import (
...
class EntityModelListView(LoginRequiredMixIn, ListView):
    template_name = 'transactions/entitiy_list.html'
...
class EntityModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/entity_create.html'
    ...
    def get_success_url(self):
        return reverse('transactions:home')
...
class EntityModelUpdateView(LoginRequiredMixIn, UpdateView):
    ...
    template_name = 'transactions/entity_update.html'
    ...
    def get_success_url(self):
        return reverse('transactions:entity-list')
...
class EntityDeleteView(LoginRequiredMixIn, DeleteView):
    slug_url_kwarg = 'entity_slug'
    context_object_name = 'entity'
    template_name = 'transactions/entity_delete.html'
...
class EntityModelDetailView(LoginRequiredMixIn,
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        if unit_slug:
            return reverse('transactions:unit-dashboard-month',
                           kwargs={
        ...
        return reverse('transactions:entity-dashboard-month',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'year': loc_date.year,
                           'month': loc_date.month,
...
class FiscalYearEntityModelDashboardView(LoginRequiredMixIn,
    ...
    context_object_name = 'entity'
    slug_url_kwarg = 'entity_slug'
    template_name = 'transactions/entity_dashboard.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        context['pnl_chart_endpoint'] = reverse(f'transactions:{url_pointer}-json-pnl',
                                                kwargs=KWARGS)
        context['payables_chart_id'] = f'djl-entity-payables-chart-{randint(10000, 99999)}'
        context['payables_chart_endpoint'] = reverse(f'transactions:{url_pointer}-json-net-payables',
                                                     kwargs=KWARGS)
        context['receivables_chart_id'] = f'djl-entity-receivables-chart-{randint(10000, 99999)}'
        context['receivables_chart_endpoint'] = reverse(f'transactions:{url_pointer}-json-net-receivables',
                                                        kwargs=KWARGS)
...
class EntityModelBalanceSheetView(LoginRequiredMixIn, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        year = localdate().year
        return reverse('transactions:entity-bs-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'year': year
                       })
...
class FiscalYearEntityModelBalanceSheetView(LoginRequiredMixIn,
    ...
    context_object_name = 'entity'
    slug_url_kwarg = 'entity_slug'
    template_name = 'transactions/balance_sheet.html'
...
class EntityModelIncomeStatementView(LoginRequiredMixIn, RedirectView):
    def get_redirect_url(self, *args, **kwargs):
        year = localdate().year
        return reverse('transactions:entity-ic-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'year': year
                       })
...
class FiscalYearEntityModelIncomeStatementView(LoginRequiredMixIn,
    ...
    context_object_name = 'entity'
    slug_url_kwarg = 'entity_slug'
    template_name = 'transactions/income_statement.html'
...
class SetDefaultEntityView(LoginRequiredMixIn, RedirectView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            self.url = reverse('transactions:entity-dashboard',
                               kwargs={
            ...
            try:
                ...
                self.url = reverse('transactions:entity-list')
...
class SetSessionDate(LoginRequiredMixIn, RedirectView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if as_of_form.is_valid():
            ...
            self.url = reverse('transactions:entity-dashboard-date',
                               kwargs={
                                   'entity_slug': self.kwargs['entity_slug'],
                                   'year': end_date.year,
