...
from transactions.forms.ledger import LedgerModelCreateForm, LedgerModelUpdateForm
...
class LedgerModelCreateView(LoginRequiredMixIn, CreateView):
    template_name = 'transactions/ledger_create.html'
...
class LedgerModelUpdateView(LoginRequiredMixIn, UpdateView):
    template_name = 'transactions/ledger_update.html'
...
class BaseLedgerBalanceSheetView(LoginRequiredMixIn, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        year = localdate().year
        return reverse('transactions:ledger-bs-year', kwargs={
            'entity_slug': self.kwargs['entity_slug'],
...
class BaseLedgerIncomeStatementView(LoginRequiredMixIn, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        year = localdate().year
        return reverse('transactions:ledger-ic-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'ledger_pk': self.kwargs['ledger_pk'],
                           'year': year
