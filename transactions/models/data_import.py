...
class ImportJobModelAbstract(CreateUpdateMixIn):
    ...
    ledger = models.ForeignKey('transactions.LedgerModel',
...
class StagedTransactionModelAbstract(CreateUpdateMixIn):
    uuid = models.UUIDField(default=uuid4, editable=False, primary_key=True)
    import_job = models.ForeignKey('transactions.ImportJobModel',
                                   on_delete=models.CASCADE)
    earnings_account = models.ForeignKey('transactions.AccountModel',
                                         on_delete=models.CASCADE,
                                         null=True,
                                         blank=True)
    ...
    tx = models.OneToOneField('transactions.TransactionModel',
