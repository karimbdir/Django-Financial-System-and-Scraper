...
from transactions.models import EntityModel, ItemThroughModel
from transactions.models.mixins import CreateUpdateMixIn, MarkdownNotesMixIn
...
class PurchaseOrderModelAbstract(CreateUpdateMixIn,
    ...
    po_items = models.ManyToManyField('transactions.ItemModel',
