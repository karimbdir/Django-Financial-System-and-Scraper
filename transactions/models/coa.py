...
from transactions.models.mixins import CreateUpdateMixIn, SlugNameMixIn
...
class ChartOfAccountModelAbstract(SlugNameMixIn,
    ...
    entity = models.OneToOneField('transactions.EntityModel',
                                  related_name='coa',
    ...
    def get_absolute_url(self):
        return reverse('transactions:coa-detail',
                       kwargs={
                           'coa_slug': self.slug,
