...
from transactions.models.coa import get_coa_account
from transactions.models.mixins import CreateUpdateMixIn
...
class LedgerModelAbstract(CreateUpdateMixIn,
    ...
    def get_absolute_url(self):
        return reverse('transactions:ledger-detail',
                       kwargs={
    ...
    def get_update_url(self):
        return reverse('transactions:ledger-update',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ledger_pk': self.uuid
                       })
