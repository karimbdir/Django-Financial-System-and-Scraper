...
from transactions.io.io_mixin import IOMixIn
from transactions.models.mixins import CreateUpdateMixIn, SlugNameMixIn, NodeTreeMixIn
...
class EntityUnitModelAbstract(IOMixIn, NodeTreeMixIn, SlugNameMixIn, CreateUpdateMixIn):
    ...
    entity = models.ForeignKey('transactions.EntityModel', on_delete=models.CASCADE, verbose_name=_('Unit Entity'))
    ...
    def get_dashboard_url(self):
        return reverse('transactions:unit-dashboard',
                       kwargs={
