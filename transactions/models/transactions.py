...
from transactions.models.unit import EntityUnitModel
...
class TransactionModelAbstract(CreateUpdateMixIn):
    ...
    journal_entry = models.ForeignKey('transactions.JournalEntryModel',
                                      related_name='txs',
                                      verbose_name=_('Journal Entry'),
                                      help_text=_('Journal Entry to be associated with this transaction.'),
                                      on_delete=models.CASCADE)
    account = models.ForeignKey('transactions.AccountModel',
                                related_name='txs',
