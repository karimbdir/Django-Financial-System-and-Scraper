...
from transactions.io import balance_tx_data, ASSET_CA_CASH, ASSET_CA_PREPAID, LIABILITY_CL_DEFERRED_REVENUE
...
class AccruableItemMixIn(models.Model):
    ...
    ledger = models.OneToOneField('transactions.LedgerModel',
