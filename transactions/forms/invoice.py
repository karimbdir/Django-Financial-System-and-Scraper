...
from transactions.models import (AccountModel, CustomerModel, InvoiceModel, ItemThroughModel, ItemModel)
...
class InvoiceModelCreateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'customer': Select(attrs={'class': transactions_FORM_INPUT_CLASSES}),
