...
from transactions.models import (ItemModel, PurchaseOrderModel, ItemThroughModel)
...
class PurchaseOrderModelUpdateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'po_status': Select(attrs={'class': transactions_FORM_INPUT_CLASSES}),
            'vendor': Select(attrs={'class': transactions_FORM_INPUT_CLASSES}),
