...
from transactions.forms.app_filters import EntityFilterForm, ActivityFilterForm
from transactions.forms.feedback import BugReportForm, RequestNewFeatureForm
from transactions.io.io_mixin import validate_activity
from transactions.models import TransactionModel, BillModel, InvoiceModel, EntityUnitModel
from transactions.settings import (
    transactions_FINANCIAL_ANALYSIS, transactions_CURRENCY_SYMBOL,
    transactions_SPACED_CURRENCY_SYMBOL)
from transactions.utils import get_default_entity_session_key, get_end_date_from_session, prepare_context_by_unit
...
def currency_symbol(spaced: bool = False):
    if spaced or transactions_SPACED_CURRENCY_SYMBOL:
        return f'{transactions_CURRENCY_SYMBOL} '
    return transactions_CURRENCY_SYMBOL
...
@register.inclusion_tag('transactions/tags/icon.html')
...
@register.inclusion_tag('transactions/tags/balance_sheet.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/income_statement.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/bank_accounts_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/data_import_job_list_table.html', takes_context=True)
def data_import_job_list_table(context):
    return context


@register.inclusion_tag('transactions/tags/data_import_job_txs_table.html', takes_context=True)
def data_import_job_txs_pending(context):
    return context


@register.inclusion_tag('transactions/tags/data_import_job_txs_imported.html', takes_context=True)
def data_import_job_txs_imported(context):
    return context


@register.inclusion_tag('transactions/tags/jes_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/txs_table.html')
...
@register.inclusion_tag('transactions/tags/txs_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/ledgers_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/invoice_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/bill_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/po_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/accounts_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/customer_table.html', takes_context=True)
def customer_table(context):
    return context


@register.inclusion_tag('transactions/tags/vendor_table.html', takes_context=True)
def vendor_table(context):
    return context


@register.inclusion_tag('transactions/tags/account_txs_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/breadcrumbs.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/default_entity.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/activity_form.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/date_picker.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/chart_container.html')
...
@register.inclusion_tag('transactions/tags/modals.html', takes_context=True)
...
def fin_ratio_max_value(ratio: str):
    params = transactions_FINANCIAL_ANALYSIS['ratios'][ratio]['ranges']
...
def fin_ratio_threshold_class(value, ratio):
    if value:
        params = transactions_FINANCIAL_ANALYSIS['ratios'][ratio]
...
@register.inclusion_tag('transactions/tags/feedback_button.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/period_navigator.html', takes_context=True)
def period_navigation(context, base_url: str):
    ...
    ctx['previous_year_url'] = reverse(f'transactions:{base_url}-year', kwargs=KWARGS)
    ctx['next_year'] = context['next_year']

    KWARGS['year'] = context['next_year']
    ctx['next_year_url'] = reverse(f'transactions:{base_url}-year', kwargs=KWARGS)

    KWARGS['year'] = context['year']
    ctx['current_year_url'] = reverse(f'transactions:{base_url}-year', kwargs=KWARGS)
    ...
    ctx['current_month_url'] = reverse(f'transactions:{base_url}-month',
    ...
    for Q in range(1, 5):
        KWARGS['quarter'] = Q
        quarter_urls.append({
            'url': reverse(f'transactions:{base_url}-quarter', kwargs=KWARGS),
            'quarter': Q,
            'quarter_name': f'Q{Q}'
        })
    del KWARGS['quarter']
    ...
    for M in range(1, 13):
        KWARGS['month'] = M
        month_urls.append({
            'url': reverse(f'transactions:{base_url}-month', kwargs=KWARGS),
            'month': M,
...
@register.inclusion_tag('transactions/tags/menu.html', takes_context=True)
        ...
        nav_menu_links = [
            {
                ...
                'url': reverse('transactions:entity-dashboard', kwargs={'entity_slug': ENTITY_SLUG})
            },
            {
                'type': 'links',
                'title': 'Management',
                'links': [
                    {
                        'type': 'link',
                        'title': 'Vendors',
                        'url': reverse('transactions:vendor-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Customers',
                        'url': reverse('transactions:customer-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Bank Accounts',
                        'url': reverse('transactions:bank-account-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Bills',
                        'url': reverse('transactions:bill-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Invoices',
                        'url': reverse('transactions:invoice-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Purchase Orders',
                        'url': reverse('transactions:po-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Inventory',
                        'url': reverse('transactions:inventory-list', kwargs={'entity_slug': ENTITY_SLUG})
                    }
                ...
                'links': [
                    {
                        'type': 'link',
                        'title': 'Entity Units',
                        'url': reverse('transactions:unit-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'My Products & Services',
                        'url': reverse('transactions:product-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Things I Pay For',
                        'url': reverse('transactions:expense-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Inventory Items',
                        'url': reverse('transactions:inventory-item-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Unit of Measures',
                        'url': reverse('transactions:uom-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                ]
            },
            {
                ...
                'links': [
                    {
                        'type': 'link',
                        'title': 'Balance Sheet',
                        'url': reverse('transactions:entity-bs', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Income Statement',
                        'url': reverse('transactions:entity-ic', kwargs={'entity_slug': ENTITY_SLUG})
                    }
                ]
            },
            {
                ...
                'links': [
                    {
                        ...
                        'url': reverse('transactions:account-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Ledgers',
                        'url': reverse('transactions:ledger-list', kwargs={'entity_slug': ENTITY_SLUG})
                    },
                    {
                        'type': 'link',
                        'title': 'Data Import',
                        'url': reverse('transactions:data-import-jobs-list', kwargs={'entity_slug': ENTITY_SLUG})
                    }
                ]
            },
            {
                ...
                'links': [
                    {
                        'type': 'link',
                        'title': 'My Entities',
                        'url': reverse('transactions:home')
                    },
                    {
                        'type': 'link',
                        'title': 'Entity Settings',
                        'url': reverse('transactions:entity-update', kwargs={'entity_slug': ENTITY_SLUG})
                    }
                ]
            }
        ]
...
@register.inclusion_tag('transactions/tags/pns_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/expense_item_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/inventory_item_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/invoice_item_formset.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/bill_item_formset.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/po_item_formset.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/uom_table.html', takes_context=True)
...
@register.inclusion_tag('transactions/tags/inventory_table.html', takes_context=True)
